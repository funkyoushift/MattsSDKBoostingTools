...
ACTION_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "load_character_late_join": {"basic": "Load Character", "aliases": ["Late Join Load", "P2 Load"]},
    "select_character_late_join": {"basic": "Create L1 Character", "aliases": ["Late Join New"]},
    "open_firmware_transfer": {"basic": "Firmware Transfer", "aliases": ["Firmware"]},
    "reset_gravity_default": {"basic": "Reset Gravity 1.0", "aliases": ["Gravity 1"]},
    ...
    "give_serial_local": {"basic": "Give Serials: Local", "aliases": ["Serial Local", "Serial Me"]},
    "give_serial_selected": {"basic": "Give Serials: Named Player", "aliases": ["Serial Sel", "Serial Named"]},
    ...
    "dev_spawner_clear": {"basic": "Clear Spawned Actors", "aliases": ["ASD Clear"]},
    "dev_spawner_reaggro": {"basic": "Re-Aggro Spawned Actors", "aliases": ["Reaggro"]},
    ...
    "hoard_harvest": {"basic": "Harvest Hoard Pads", "aliases": ["Harvest Spawn Points"]},
    ...
    "movement_apply_fly_speed": {"basic": "Apply Fly Speed", "aliases": ["Fly Speed"]},
    ...
    "movement_teleport_all_to_me": {"basic": "Teleport All to Me", "aliases": ["TP All"]},
    ...
    "third_person_on": {"basic": "Third Person On", "aliases": ["TPC On", "3P On"]},
    "third_person_off": {"basic": "Third Person Off", "aliases": ["TPC Off", "3P Off"]},
    "third_person_toggle": {"basic": "Third Person", "aliases": ["TPC", "3P", "Camera"]},
    "third_person_status": {"basic": "Third Person Status", "aliases": ["TPC Status"]},
    "fog_of_war_clear": {"basic": "Host Clear Fog", "aliases": ["Fog Clear", "Clear Fog", "NoFog"]},
    "host_clear_fog": {"basic": "Host Clear Fog", "aliases": ["Host Fog", "Tile Fog"]},
    "party_reveal_start": {"basic": "Party Reveal Map", "aliases": ["Party Fog", "Guest Fog", "Reveal Guests"]},
    "party_reveal_abort": {"basic": "Abort Party Reveal", "aliases": ["Stop Reveal", "Fog Abort"]},
    "party_reveal_status": {"basic": "Party Reveal Status", "aliases": ["Reveal Status"]},
    ...
    "set_backpack_bank_selected": {"basic": "Set Selected Inventory", "aliases": ["Inv Sel"]},
    "set_backpack_bank_all": {"basic": "Set Party Inventory", "aliases": ["Inv All"]},
    ...
    "chaos_drop_backpack_targeted": {"basic": "Drop All Backpack (Target Scope)", "aliases": ["Drop Scoped", "Drop Target Bag"]},
...
NATIVE_PICKER_ACTIONS: tuple[str, ...] = (
    ...
    "open_firmware_transfer",
    "reset_gravity_default",
    "drop_all_shinies",
    "shiny_selected",
    "shiny_all",
    "shiny_nonhost",
    ...
    "movement_teleport_selected_to_me",
    "movement_teleport_me_to_selected",
    "movement_teleport_all_to_me",
    "hoard_start",
    "hoard_stop",
    "hoard_clear",
    "hoard_harvest",
    "location_bookmark_save",
    "spawn_itempool_cancel",
    "movement_super_dash",
...
ALLOWED_PAYLOAD_KEYS: dict[str, frozenset[str]] = {
    ...
    "movement_toggle_noclip": frozenset({"movement_scope", "scope", "fly_speed", "movement_fly_speed"}),
    "movement_toggle_force_fly": frozenset({"movement_scope", "scope", "fly_speed", "movement_fly_speed"}),
    "movement_apply_fly_speed": frozenset({"movement_scope", "scope", "fly_speed", "movement_fly_speed"}),
    "give_serial_local": _SERIAL_PAYLOAD_KEYS,
