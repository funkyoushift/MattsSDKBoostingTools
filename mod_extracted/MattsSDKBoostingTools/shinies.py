...
SHINY_ITEMPOOLS: tuple[str, ...] = (
    ...
    "itempool_dad_sm_05_legendary_loarmaster_shiny",
    ...
    "itempool_mal_sg_05_legendary_DiscyBusiness_shiny",
    ...
    "itempool_mal_sr_05_legendary_manifest_shiny",
    ...
    "itempool_tor_sg_05_legendary_Cormano_shiny",
    ...
    "itempool_vla_sm_05_legendary_brickhouse_shiny",
