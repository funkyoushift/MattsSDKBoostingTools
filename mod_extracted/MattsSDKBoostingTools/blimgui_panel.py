...
from .game_parameters import (
    CURRENCY_KINDS as _CURRENCY_KINDS, EXP_TRACKS as _EXP_TRACKS,
    MAX_PLAYER_LEVEL as _MAX_PLAYER_LEVEL, MAX_ITEM_LEVEL as _MAX_ITEM_LEVEL,
    MAX_SPEC_LEVEL as _MAX_SPEC_LEVEL, MAX_VAULT_CARD_LEVEL as _MAX_VAULT_CARD_LEVEL,
)
...
_GZO_CLASS_NAMES = {
    ...
    "robodealer": "C4SH", "corpohacker": "Loveless", "corpo_hacker": "Loveless",
    "hacker": "Loveless", "loveless": "Loveless",
}
...
def _max_all_selected() -> None:
    ...
    if pc is not None:
        ...
        for vc_kind in _CURRENCY_KINDS[2:]:
            _do_give_currency(vc_kind, _MAX_WALLET_AMOUNT, name)
        for vc_xp in _EXP_TRACKS[2:]:
...
_GZO_CLASS_ALIASES.update({"robodealer": "C4SH", "corpohacker": "Loveless", "corpo_hacker": "Loveless", "hacker": "Loveless", "loveless": "Loveless"})
