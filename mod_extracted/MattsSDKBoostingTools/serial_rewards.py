...
# Larger packages = fewer round-trips. Still capped by the 20k char budget below.
_SERIAL_DELIVERY_SAFE_SERIALS_SELECTED = 40
_SERIAL_DELIVERY_SAFE_SERIALS_MULTI = 30
_SERIAL_DELIVERY_PER_SERIAL_OVERHEAD_CHARS = 16
# Automatic chunk delivery pacing. Keep this main-thread/tick driven; no sleeps.
# Tuned for speed while still giving the game a beat to create/open reward packages.
_SERIAL_DELIVERY_PRE_OPEN_DELAY_SEC = 0.30
_SERIAL_DELIVERY_POST_OPEN_DELAY_SEC = 1.50
_SERIAL_DELIVERY_SELECTED_POST_OPEN_DELAY_SEC = 1.25
_SERIAL_DELIVERY_MULTI_POST_OPEN_DELAY_SEC = 2.00
