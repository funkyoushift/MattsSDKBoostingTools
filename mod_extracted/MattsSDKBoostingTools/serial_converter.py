...
def _read_header_numbers(serial):
    ...
    Catalog / in-game @U codes can fail a full part parse (`unknown part subtype`)
    while still carrying a valid `type, flags, flags, level|` header. Level
    override only needs that header.
    """
