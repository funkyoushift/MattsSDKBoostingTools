...
contextBridge.exposeInMainWorld("msbt", {
  ...
  detectOak2: (sdkModsPath) => ipcRenderer.invoke("app:detectOak2", sdkModsPath),
  ...
  recheckSdkStack: (sdkModsPath) => ipcRenderer.invoke("app:recheckSdkStack", sdkModsPath),
  ...
  getDataCacheInfo: () => ipcRenderer.invoke("app:getDataCacheInfo"),
  openDataCacheFolder: () => ipcRenderer.invoke("app:openDataCacheFolder"),
  clearDataCatalogCache: () => ipcRenderer.invoke("app:clearDataCatalogCache"),
  ...
  loadMattEditorPrefs: () => ipcRenderer.invoke("app:loadMattEditorPrefs"),
  saveMattEditorPrefs: (payload) => ipcRenderer.invoke("app:saveMattEditorPrefs", payload),
  mattEditorOpenFile: (kind) => ipcRenderer.invoke("app:mattEditorOpenFile", kind),
  mattEditorReopenFile: (kind) => ipcRenderer.invoke("app:mattEditorReopenFile", kind),
  mattEditorSaveFile: (payload) => ipcRenderer.invoke("app:mattEditorSaveFile", payload),
