...
**Current release: [v2.8.3](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/tag/v2.8.3)** — F7 Quick Menu clicks work after travel, human serials encode locally, and Ground Loot can pull/hide/delete by distance and player scope.
...
[![Installer downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Installer-v2.8.3.exe?label=Installer%20downloads&color=2ea44f)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
[![Portable downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Portable-v2.8.3-win-x64.zip?label=Portable%20downloads&color=0969da)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
...
- Latest installer example: `MSBT-Installer-v2.8.3.exe`
