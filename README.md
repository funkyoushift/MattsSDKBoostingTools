...
**Current release: [v2.8.6](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/tag/v2.8.6)** — Inventory Select All Filtered keeps Send to Game pinned on screen.
...
[![Installer downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Installer-v2.8.6.exe?label=Installer%20downloads&color=2ea44f)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
[![Portable downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Portable-v2.8.6-win-x64.zip?label=Portable%20downloads&color=0969da)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
...
- Latest installer example: `MSBT-Installer-v2.8.6.exe`
