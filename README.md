...
**Current release: [v2.11.2](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/tag/v2.11.2)** — embedded editor update: complete Loveless cosmetics and skill lookups, Providence/BP5 controls, level-70 defaults, explicit XP editing, and current catalog badges.
...
[![Installer downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Installer-v2.11.2.exe?label=Installer%20downloads&color=2ea44f)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
[![Portable downloads](https://img.shields.io/github/downloads/funkyoushift/MattsSDKBoostingTools/latest/MSBT-Portable-v2.11.2-win-x64.zip?label=Portable%20downloads&color=0969da)](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/latest)
...
- Latest installer example: `MSBT-Installer-v2.11.2.exe`
