...
**Recommended build: `0.1.0-beta.17`** — current working open beta.
...
1. **Install page** (recommended on phone):  
   ...
   Testers should confirm **More → About** shows **`0.1.0-beta.17`** (or newer).
2. **Test kit zip** — `MSBT-Mobile-Beta-Test-Kit-0.1.0-beta.17.zip` from the same [mobile-beta](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/tag/mobile-beta) prerelease.
