...
2. **Test kit zip** — `MSBT-Mobile-Beta-Test-Kit-0.1.0-beta.9.zip` from the same [mobile-beta](https://github.com/funkyoushift/MattsSDKBoostingTools/releases/tag/mobile-beta) prerelease (or CI artifact).
