...
**Current recommended build: `0.1.0-beta.14`** (verified working for live pairing + core tabs).
...
Confirm **More → About** shows **`0.1.0-beta.14`** (or newer). Install **over** older mobile betas so local data survives.
