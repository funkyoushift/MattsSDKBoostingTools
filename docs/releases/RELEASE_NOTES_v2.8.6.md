...
- **Select All Filtered keeps Send to Game on screen** — the inventory send strip stays pinned at the bottom instead of sitting below the item grid
- **Send to Game / Serial Rewards** still deliver every red-selected serial
...
Download and run:
- `MSBT-Installer-v2.8.6.exe`

**Manual install / portable Electron app**

Download and extract:
- `MSBT-Portable-v2.8.6-win-x64.zip`
