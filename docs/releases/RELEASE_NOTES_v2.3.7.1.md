...
Download and run:
- `MSBT-Installer-v2.3.7.1.exe`

**Manual install / portable Electron app**

Download and extract:
- `MSBT-Portable-v2.3.7.1-win-x64.zip`
...
1. Install `MSBT-Installer-v2.3.7.1.exe` (or extract the portable ZIP).
2. Open Updates → **Install / Update SDK Mod** if needed.
3. **Fully restart Borderlands 4** so the SDK and bridge load.
