...
| Path | What |
| --- | --- |
| [`legacy_tkinter/`](legacy_tkinter/) | Old Tkinter packaging scripts (`build_external_exe.ps1`, `package_external_beta.ps1`, launcher BAT, requirements). Electron is the shipping UI. |
